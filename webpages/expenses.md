...
As a club sport, the team receives no school funding, so annual dues and fundraisers are the financial foundation of the team. We ask that each individual Rider be responsible for paying dues for the 2018 season of $350 and commit to individual fundraising efforts totaling $250 ($300 if using the online eTeamSponsor option). If the Rider raises less than $250 (or $300 using eTeamSponsor), then additional dues must be paid to make up the difference. See [here](https://docs.google.com/forms/d/e/1FAIpQLScfcym66MpvPf0YRAgc3Jh5c0cydRzAuKzPRNCvex9v8dmcGQ/viewform) for dues and fundraising details.
