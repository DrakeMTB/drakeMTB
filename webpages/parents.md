...
||||
|[Tam District Release of Liability Form]({{site.baseurl}}/images/2016_Tam_District_Release_of_Liability_form.pdf) and [Administrative Regulation 6145.5]({site.baseurl}}/images/AR_6145.5.pdf), which contains important limitations on the scope of Drake MTB's club activities| The Release of Liability form must be printed out, filled out, and either turned in to the Drake office or scanned and emailed to Dan Freeman (dfreeman@tamdistrict.org) and Jolie Jacobs  (jjacobs@tamdistrict.org) |            January 30th |
||||
