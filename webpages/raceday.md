...
Minute-by-minute schedules are provided for each category for each race ([click for example for freshman boys]({{site.baseurl}}/images/race1_sched_boys_frosh.JPG)), but the information above gives new Riders and Parents an idea of what the flow of the day looks like.
